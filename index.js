...
function update() {
    ...
    //make sure the word guessed is in guessList
    let guessWord = "";
    for (let i = 0; i < width; i++) {
        ...
        guessWord += currTile.innerText;
    }

    guessWord = guessWord.toLowerCase();

    if (!guessList.includes(guessWord)) {
        var currTile = document.getElementById("answer");
        var currVal = "";
        ...
        currTile.innerText = "Not in word list"
        return;
    }
    ...
    for (let i = 0; i < width; i++) {
        ...
        var currKb = document.getElementById("Key" + currTile.innerText);
